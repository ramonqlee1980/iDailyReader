...
@implementation AutoHideMenuView
...
#define kTipButtonYOffset 148.0f
+ (CGRect)getFrame
{
    return CGRectMake((320.0 - 296.0)/2.0,460.0 - kTipButtonYOffset + 14,296.0,148.0);
}
...
{
    rect[kThirdRowRightMost] =  CGRectMake(251,93,25,25);
...
- (void)showOrHideMenu
{
    ...
    if (!isMenuHidden) 
    {
        self.frame = [AutoHideMenuView getHideFrame];
    }
    else
    {
        self.frame = [AutoHideMenuView getFrame];
    }
