...
@interface PopupTableView (private)
- (void)fadeIn;
- (void)fadeOut;
@end
...
{
    static NSString *cellIdentity = @"PopupTableViewCell";
    
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIdentity];
    if (cell ==  nil) {
        cell = [[[PopupTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentity] autorelease];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(popTableView:didSelectedIndex:)]) {
        [self.delegate popTableView:self didSelectedIndex:[indexPath row]];
    }
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(popTableViewDidCancel)]) {
        [self.delegate popTableViewDidCancel];
    }
