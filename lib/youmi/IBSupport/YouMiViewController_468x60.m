...
#import "YouMiViewController_468x60.h"
#import "Constants.h"


@implementation YouMiViewController_468x60
@synthesize adView;

- (void)awakeFromNib {
	adView = [[YouMiView alloc] initWithContentSizeIdentifier:YouMiBannerContentSizeIdentifier468x60 delegate:nil];
