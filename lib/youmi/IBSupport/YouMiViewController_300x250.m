...
#import "YouMiViewController_300x250.h"
#import "Constants.h"


@implementation YouMiViewController_300x250
@synthesize adView;

- (void)awakeFromNib {
	adView = [[YouMiView alloc] initWithContentSizeIdentifier:YouMiBannerContentSizeIdentifier300x250 delegate:nil];
