...
typedef enum {
    ...
    AdSageBannerAdViewSize_48X48                        = 6,
    AdSageBannerAdViewSize_256X192                      = 7,
    AdSageBannerAdViewSize_748X60                       = 8,
    AdSageBannerAdViewSize_120X480                      = 9,
    AdSageBannerAdViewSize_210X177                      = 10,
...
//获取banner广告
+ (AdSageView *)createAdSageBannerAdView:(id<AdSageDelegate>)delegate sizeType:(AdSageBannerAdViewSizeType)sizeType;
//获取全屏广告
+ (AdSageView *)createAdSageFullScreenAdView:(id<AdSageDelegate>)delegate;
