 ...
 *适用于单账户用户
 */
-(void)immobViewReducscore:(NSInteger)score WithAdUnitID:(NSString *)adUnitId;
/**
 *此方法用于向服务器申请减少积分
 *适用于多账户用户
 *accountId 用户的账户名称
 */
-(void)immobViewReducscore:(NSInteger)score WithAdUnitID:(NSString *)adUnitId WithAccountID:(NSString *)accountId;
@end
